...
@Component
public class MsgedFallback implements FallbackFactory<RESTClientEmissionService>{

	@Override
	public RESTClientEmissionService create(Throwable cause) {
		return new RESTClientEmissionService() {
