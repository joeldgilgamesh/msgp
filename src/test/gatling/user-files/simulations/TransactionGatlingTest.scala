...
class TransactionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Transaction entity")
        ...
        .repeat(2) {
            ...
            .get("/services/spminfimsgp/api/transactions")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new transaction")
            .post("/services/spminfimsgp/api/transactions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "codeTransaction":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/spminfimsgp${new_transaction_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created transaction")
            .delete("/services/spminfimsgp${new_transaction_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
